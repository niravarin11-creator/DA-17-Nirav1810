...
SELECT 
    c.customer_name,
    SUM(o.quantity * p.unit_price) AS total_completed_value
FROM Customers c
...
from Orders as o
 ...
 on o.product_id = p.product_id
 where o.order_status = 'Completed'
 group by e.employee_id,e.employee_name,o.order_status
 having SUM(p.unit_price * o.quantity) > 500000;
...
on s.employee_id = o.sales_employee_id;
